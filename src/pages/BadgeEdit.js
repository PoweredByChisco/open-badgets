...
class BadgeNew extends React.Component {
  ...
  handleSubmit = async (e) => {
    ...
    try {
      ...
      this.props.history.push("/badges") /* Las paginas reciben 3 props a traves de react router. Match, history y location, en este caso con history podemos redirigir a una pagina */
    } catch (error) {
